        ...
        <section className={styles.hero_section}>
          <div className={styles.hero_left}>
            <div className={styles["dashboard-hero-txt"]}>
              <div className={styles["dashboard-hero-first-text-cont"]}>
                <p className={styles["dashboard-hero-first-text"]}>
                  Today’s Subject <img src={arr} alt="arrow" /> English Hero
                </p>
                <p className={styles.lesson}>Lesson- Phonics Module 1-6</p>
              </div>
              <p style={{ fontFamily: "Actor" }}>
          ...
          <div className={styles.hero_right}>
            <section className={styles.recent_txt}>
              ...
              <Link>
                <p className={styles.recent_txt_right}>
                  View more <img src={heroarrowright} alt="" />
                </p>
              </Link>
            </section>
        ...
        <main className={styles.main_section}>
          <div className={styles["main-header-container"]}>
            ...
            <div>
              ...
              <Link>
                <p className={styles.recent_txt_right}>
                  view all <img src={heroarrowright} alt="Arrow" />
                </p>
              </Link>
            </div>
          </div>
              ...
              <div className={styles.subject}>
                ...
                <Link to="/dashboard/subjects">
                  <p className={styles.view_more}>
                    View more <img src={heroarrowright} alt="View More" />
                  </p>
                </Link>
              </div>
                ...
                <div className={styles.subject_card}>
                  {DashSubject.map((subject) => (
                    <div key={subject.id}>
                      ...
                      <p className={styles.subject_description}>
                  ...
                  {DashChallenges.map((challenge) => (
                    <div key={challenge.id}>
                      ...
                      <div className={styles.challenge_body}>
                        <p className={styles.challenge_cap}>
                          {challenge.challengecap}
                        </p>
